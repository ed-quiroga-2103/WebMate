    ...
    const submitInfo = async (event) => {
        ...
        if (data.password !== refPassword.current.value) {
            ...
            const response = await auth.register({
                ...
                admitionYear: data.carnet.substring(0, 4),
        ...
        <main className={`${base}__root`}>
            ...
            <div className={`${base}__body`}>
                <div className={`${base}__body__container`}>
                    ...
                    >
                        <div
                            className={`${base}__body__container__form__wrapper`}
                        >
                            <label
                        ...
                        >
                            ...
                            >
                                <option
                                    name="computadores"
                                    value="Ingeniería en Computadores"
                                >
                                ...
                                <option
                                    name="mante"
                                    value="Ingeniería en Mantenimiento"
                                >
                        ...
                        >
                            ...
                            <input
                                ...
                                // pattern="[a-z0-9]+@[a-z]+\.[a-z]{2,3}.[a-z]{2,3}" // No funciona correctamente
                                title="Wrong email"
                                onInput={(event) => {
