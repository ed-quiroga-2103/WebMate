                ...
                <div className={`${base}__wrapper__container`}>
                    <div className={`${base}__wrapper__container__firstRow`}>
                        <div className={`${base}__singleCard`}>
                            <div className={`${base}__singleCard__header`}>
                                <h2
                                    className={`${base}__singleCard__header__title`}
                                >
                                    Promedio
                                </h2>
                            </div>
                            <div className={`${base}__singleCard__average`}>
                                ...
                                {average.status ? (
                                    <p
                                        className={`${base}__singleCard__average__up`}
                                    >
                                        &uarr;
                                    </p>
                                ) : (
                                    <p
                                        className={`${base}__singleCard__average__down`}
                                    >
                                        &darr;
                                    </p>
                                )}
                        ...
                        <div className={`${base}__singleCard`}>
                            ...
                            <div className={`${base}__singleCard__next`}>
                                <p
                                    className={`${base}__singleCard__next__info`}
                                >
                                    {next.type} - {next.course}: {next.date}
                                </p>
                            </div>
                        </div>
                        <div
                            onClick={(event) => goTo(event, 'courses')}
                            className={`${base}__singleCard--ultimo`}
                        >
                            <h2 className={`${base}__singleCard__title`}>
                                Ultimo Curso Visitado
                            </h2>
                        </div>
                    </div>
                    <div className={`${base}__wrapper__container__secondRow`}>
                        <div className={`${base}__bigCard`}>
                            ...
                            <Line
                                className={`${base}__bigCard__chart`}
                                options={options}
                                data={data}
                            />
                        </div>
                        <div className={`${base}__smallCard`}>
                            <div className={`${base}__smallCard__header`}>
                                <h2
                                    className={`${base}__smallCard__header__title`}
                                >
                                    Ultimas notas
                                </h2>
                            </div>
                            <div className={`${base}__smallCard__info`}>
                                {lastGrades.map((grade, index) => {
                                    return (
                                        <div
                                            key={index}
                                            className={`${base}__smallCard__info__grade`}
                                        >
                                            <p
                                                className={`${base}__smallCard__info__grade__text`}
                                            >
                                                {grade.course}
                                            </p>
                                            <p
